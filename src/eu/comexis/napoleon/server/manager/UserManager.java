...
/**
 * Class uses for manage interactions with user and client entities !!! Should call the datastore
 * via objectify to retrieve information concerning user and client.
 * 
 * @author jDramaix
 * 
 */
